...
<body>
	...
	<div class="banner">
		<div class="shape pos-bg">
			<img src="/pixelappy/assets/img/bg/home-bg.png" alt="">
		</div>
			...
			<div class="row h-100 align-items-center">
				...
				<div class="col-lg-5">
					<div class="banner-img img-100" data-aos="fade-left">
						<img src="/pixelappy/assets/img/bg/mob-img.png" alt="">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mob-testi.png" alt="">
							</div>
						</div>
						<div class="col-lg-6">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi2.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi3.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi4.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi5.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi6.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi7.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi8.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi9.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi10.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 align-self-center">
							<div class="testi-img">
								...
								<img src="/pixelappy/assets/img/mix/mobile-testi11.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="testi-content">
	...
	<?php include($_SERVER['DOCUMENT_ROOT']."/pixelappy/includes/slider-redefined.php"); ?>

	<section class="stripe-3 bg-detail flex-sec" style="background: url(/pixelappy/assets/img/thumbnails/thumb-2.jpg);">
		<div class="container">
		...
		<div class="box-img" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="3000">
			<img src="/pixelappy/assets/img/mix/box-img.png" alt="">
		</div>
	</section>

	<?php include($_SERVER['DOCUMENT_ROOT']."/pixelappy/includes/mob-sec.php"); ?>
	<?php include($_SERVER['DOCUMENT_ROOT']."/pixelappy/includes/project-sec.php"); ?>
	<?php include($_SERVER['DOCUMENT_ROOT']."/pixelappy/includes/tabs-sec.php"); ?>
